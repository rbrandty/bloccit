...
RSpec.describe SponsoredPost, type: :model do
  ...
  let(:sponsored_post) { topic.sponsored_posts.new(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_sponsored_post_price) }
